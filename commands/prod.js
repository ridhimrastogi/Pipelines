...
async function run(status) {    
    ...
    if (status == 'up') {                
        let requiredServers =[{serverName: 'ansiblesrv', slug: '512mb' },{serverName: 'jenkinssrv', slug: 's-2vcpu-4gb' },{serverName: 'checkiosrv', slug: '512mb' },{serverName: 'itrustsrv', slug: '512mb' }];
        let serverInfos = {};
